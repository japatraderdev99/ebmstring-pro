...
export const HIGHLIGHTS: Record<string, Highlight> = {
  catalogo: {
    ...
    sub: "Cordas premium",
    stories: [
      { kind: "intro", kicker: "Catálogo EBM", big: "9 cordas premium, dissecadas em 6 eixos técnicos.", note: "Análise científica pra você escolher certo." },
      { kind: "list", kicker: "Pra controle", title: "Bola sempre dentro", items: ["Head Lynx Tour", "Wilson Poly Pro", "Gamma Poly Z"] },
      { kind: "list", kicker: "Pra spin", title: "Giro de elite", items: ["Solinco Hyper-G", "Yonex PolyTour Spin", "Yonex PolyTour Pro"] },
  ...
  entrega: {
    ...
    stories: [
      ...
      { kind: "list", kicker: "Onde atendemos", title: "Floripa e São José", items: ["Florianópolis", "São José"] },
